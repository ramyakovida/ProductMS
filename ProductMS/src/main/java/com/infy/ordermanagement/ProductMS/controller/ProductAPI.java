package com.infy.ordermanagement.ProductMS.controller;
...
import com.infy.ordermanagement.ProductMS.service.ProductService;
...
public class ProductAPI {
	...
	public ResponseEntity<String> addProduct(@RequestBody ProductDTO prod){
		...
		try {
			Integer msg = productService.addProduct(prod);
			String s = "This product is added with id:"+msg;
	...
	public ResponseEntity<ProductDTO> getByProductId(@PathVariable Integer id)
	{
		try {
	...
	public ResponseEntity<Boolean> updateStock(@PathVariable Integer prodId, @PathVariable Integer quantity){		
		try {
